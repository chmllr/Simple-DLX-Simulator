...
instance Show Instruction where
    ...
    show (R s1 s2 s3 i s4)   =   s4 ++ " " ++ s1 ++ " " ++ s2 ++ " " ++ s3 ++ " "++ show i
    show (J s i)   =   s ++ " " ++ show i
    show Illegal = "Illegal"

-- instruction name to opcode converter
id2opc	"j"	=	[f,f,f,f,t,f]
id2opc	"jal"	=	[f,f,f,f,t,t]
id2opc	"beqz"	=	[f,f,f,t,f,f]
id2opc	"bnez"	=	[f,f,f,t,f,t]
id2opc	"addi"	=	[f,f,t,f,f,t]
id2opc	"subi"	=	[f,f,t,f,t,t]
id2opc	"andi"	=	[f,f,t,t,f,f]
id2opc	"ori"	=	[f,f,t,t,f,t]
id2opc	"xori"	=	[f,f,t,t,t,f]
id2opc	"lhgi"	=	[f,f,t,t,t,t]
id2opc	"jr"	=	[f,t,f,t,t,f]
id2opc	"jalr"	=	[f,t,f,t,t,t]
id2opc	"clri"	=	[f,t,t,f,f,f]
id2opc	"sgri"	=	[f,t,t,f,f,t]
id2opc	"seqi"	=	[f,t,t,f,t,f]
id2opc	"sgei"	=	[f,t,t,f,t,t]
id2opc	"slsi"	=	[f,t,t,t,f,f]
id2opc	"snei"	=	[f,t,t,t,f,t]
id2opc	"slei"	=	[f,t,t,t,t,f]
id2opc	"seti"	=	[f,t,t,t,t,t]
id2opc	"lb"	=	[t,f,f,f,f,f]
id2opc	"lh"	=	[t,f,f,f,f,t]
id2opc	"lw"	=	[t,f,f,f,t,t]
id2opc	"lbu"	=	[t,f,f,t,f,f]
id2opc	"lhu"	=	[t,f,f,t,f,t]
id2opc	"sb"	=	[t,f,t,f,f,f]
id2opc	"sh"	=	[t,f,t,f,f,t]
id2opc	"sw"	=	[t,f,t,f,t,t]
id2opc 	"slli"	=	[f,f,f,f,f,f]
id2opc 	"srli"	=	[f,f,f,f,t,f]
id2opc 	"srai"	=	[f,f,f,f,t,t]
id2opc 	"sll"	=	[f,f,f,t,f,f]
id2opc 	"srl"	=	[f,f,f,t,t,f]
id2opc 	"sra"	=	[f,f,f,t,t,t]
id2opc 	"add"	=	[t,f,f,f,f,t]
id2opc 	"sub"	=	[t,f,f,f,t,t]
id2opc 	"and"	=	[t,f,f,t,f,f]
id2opc 	"or"	=	[t,f,f,t,f,t]
id2opc 	"xor"	=	[t,f,f,t,t,f]
id2opc 	"lhg"	=	[t,f,f,t,t,t]
id2opc 	"clr"	=	[t,f,t,f,f,f]
id2opc 	"sgr"	=	[t,f,t,f,f,t]
id2opc 	"seq"	=	[t,f,t,f,t,f]
id2opc 	"sge"	=	[t,f,t,f,t,t]
id2opc 	"sls"	=	[t,f,t,t,f,f]
id2opc 	"sne"	=	[t,f,t,t,f,t]
id2opc 	"sle"	=	[t,f,t,t,t,f]
id2opc 	"set"	=	[t,f,t,t,t,t]

-- register address to bitvector converter
reg2bv (r:rs)	=	drop 27 (int2bv (read rs :: Int))

-- whole instruction to bitvector converter
instr2bv	(I id rs1 rd imm)	=	id2opc id ++ reg2bv rs1 ++ reg2bv rd ++ drop 16 (int2bv imm)
instr2bv	(R rs1 rs2 rd sa fu)	=	[f,f,f,f,f,f] ++ reg2bv rs1 ++ reg2bv rs2 ++ reg2bv rd ++ drop 27 (int2bv sa) ++ id2opc fu
instr2bv	(J id imm)		=	id2opc id ++ drop 6 (int2bv imm)
